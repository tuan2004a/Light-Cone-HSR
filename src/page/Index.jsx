    ...
    return (
        <div className="size-full">
            ...
            <main className="flex items-center justify-between overflow-hidden h-[calc(100vh-123px)]">
                ...
                <nav className="w-[330px] h-full custom-scrollbar-sidbar-char space-y-4 is-vertically-scrollable">
                    {lightConeData.length > 0 && lightConeData.map((items, index) => (
                        <LightCone ItemData={items} onSelectItem={(selected) => setSelectItem(selected)} />
                    ))}
                </nav>
            ...
            <div className='flex items-center justify-between'>
                <div>
                    <Button onClick={handleNoticesSystem} className="size-10">
                ...
                <div className='flex items-center space-x-7'>
                    ...
                    <div>
                        <Button className="Text-Shadow !bg-black/50 !text-[#4ce7fe] w-[330px] h-[45px] !text-[17.5px] after:!border-0">
